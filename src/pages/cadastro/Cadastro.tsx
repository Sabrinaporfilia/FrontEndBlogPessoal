...
function Cadastro() {
  ...
  async function cadastrarNovoUsuario(e: ChangeEvent<HTMLFormElement>) {
    ...
    if (confirmaSenha === usuario.senha && usuario.senha.length >= 8) {
      ...
      toastAlerta('Dados inconsistentes. Verifique as informações de cadastro.', 'sucesso')
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 h-screen place-items-center font-bold bg-slate-950">
        ...
        <form className='flex justify-center items-center flex-col w-2/3 gap-3' onSubmit={cadastrarNovoUsuario}>
          ...
          <div className="flex justify-around w-full gap-8">
            <button className='rounded text-white bg-red-700 hover:bg-red-600 w-1/2 py-2' onClick={back}>
              Cancelar
            </button>
            <button className='rounded text-white bg-fuchsia-950 hover:bg-fuchsia-900 w-1/2 py-2' type='submit'>
              Cadastrar
            </button>
          </div>
        </form>
